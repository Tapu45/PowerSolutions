      ...
      <div className="pointer-events-none absolute inset-x-0 top-0 h-20 md:h-24 bg-gradient-to-b from-slate-900/60 via-slate-900/20 to-transparent z-[1]">
        ...
        <div className="absolute left-6 top-24 bottom-24 flex flex-col items-center gap-3">
          ...
          <div className="pointer-events-auto flex flex-col items-center gap-3 -mt-full">
            <div className="rounded-xl border border-cyan-200/30 bg-white/60 backdrop-blur-md shadow-sm p-2">
              <img
            ...
            <div className="rounded-xl border border-yellow-300/30 bg-white/60 backdrop-blur-md shadow-sm p-2">
              <img
            ...
            <div className="rounded-xl border border-blue-300/30 bg-white/60 backdrop-blur-md shadow-sm p-2">
              <img
        ...
        <div className="absolute right-6 top-24 bottom-24 flex flex-col items-center gap-3">
          ...
          <div className="pointer-events-auto flex flex-col items-stretch gap-2 -mt-full">
            <div className="rounded-full border border-blue-300/30 bg-white/60 backdrop-blur-md shadow-sm px-3 py-1 text-xs font-medium text-gray-700">
              ERP
            </div>
            <div className="rounded-full border border-cyan-200/30 bg-white/60 backdrop-blur-md shadow-sm px-3 py-1 text-xs font-medium text-gray-700">
              Consulting
            </div>
            <div className="rounded-full border border-yellow-300/30 bg-white/60 backdrop-blur-md shadow-sm px-3 py-1 text-xs font-medium text-gray-700">
              Apps
            </div>
            <div className="rounded-full border border-cyan-200/30 bg-white/60 backdrop-blur-md shadow-sm px-3 py-1 text-xs font-medium text-gray-700">
              Innovation
